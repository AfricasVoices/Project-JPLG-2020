...
if __name__ == "__main__":
    ...
    uuids = set()
    district_counts = {district: 0 for district in TARGET_DISTRICTS}
    for path in traced_data_paths:
        ...
        log.info(f"Searching for participants from the target districts ({TARGET_DISTRICTS})...")
        file_uuids = set()
        file_district_counts = {district: 0 for district in TARGET_DISTRICTS}
        for td in data:
